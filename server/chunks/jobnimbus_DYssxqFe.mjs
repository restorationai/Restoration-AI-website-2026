...
const faqs = [
  {
    question: "Does this integrate with JobNimbus?",
    answer: "Restoration AI works alongside your workflow so you get better call handling without changing your system."
  },
  {
    question: "Why do I need this if I already use JobNimbus?",
    answer: "JobNimbus manages jobs, but it doesn’t control how calls are handled. This fixes the intake side."
  },
  {
  ...
  },
  {
    ...
    answer: "No, your team keeps using JobNimbus like normal."
  },
  {
...
function JobNimbusHomepage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen bg-white font-sans overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative z-10 pt-36 pb-32 px-6 lg:px-12 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-6 md:space-y-7", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[17px] text-slate-500 max-w-[540px] leading-[1.6] font-medium", children: "Restoration AI works alongside JobNimbus so your team can answer every call, capture better job details, and move faster without changing your system." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[17px] text-slate-500 max-w-[540px] leading-[1.6] font-medium pb-2", children: "Built for restoration companies that want faster intake, cleaner job information, and zero missed opportunities." })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 w-full flex justify-center lg:justify-end lg:self-start lg:mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: "https://assets.cdn.filesafe.space/Tx5eKisj3Xluq1SeZKe3/media/69e507ee2c135a8c835819e8.png",
          alt: "JobNimbus Logo",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative z-10 pt-24 pb-12 px-6 max-w-[800px] mx-auto text-center space-y-7", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[36px] md:text-[46px] lg:text-[52px] font-extrabold text-slate-900 tracking-tight leading-[1.1]", children: "JobNimbus Is Only as Good as the Information Going Into It" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 flex flex-col items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[17px] text-slate-500 leading-[1.6] font-medium max-w-3xl", children: "JobNimbus helps manage your jobs, but it still depends on how calls are handled. If calls are rushed, inconsistent, or handled the wrong way, your team starts every job with bad information. Restoration AI fixes that by making sure every call is handled properly before it ever reaches your workflow." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative z-10 pt-8 pb-24 px-6 max-w-[800px] mx-auto text-center space-y-7", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[17px] text-slate-500 leading-[1.6] font-medium", children: "Restoration AI answers calls instantly, handles restoration conversations correctly, captures key job details, and keeps everything moving. Your team gets clean, structured information instead of messy notes or missed details." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative z-10 pb-16 px-6 lg:px-12 max-w-7xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-10 md:gap-14 relative z-10 w-full py-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-10 lg:p-14 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col items-center text-center mx-auto max-w-4xl w-full relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[17px] lg:text-[18px] text-slate-500 leading-relaxed font-medium", children: "Every call is picked up right away and handled the correct way from the start." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-10 lg:p-14 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col items-center text-center mx-auto max-w-4xl w-full relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[17px] lg:text-[18px] text-slate-500 leading-relaxed font-medium", children: "All important information is collected cleanly so your team doesn’t have to guess later." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-10 lg:p-14 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col items-center text-center mx-auto max-w-4xl w-full relative z-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[17px] lg:text-[18px] text-slate-500 leading-relaxed font-medium", children: "Your team gets what they need immediately so they can respond faster and win more jobs." })
        ] })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[16px] text-slate-500 leading-relaxed font-medium", children: "Handles water, fire, and mold calls correctly" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[42px] h-[42px] rounded-full bg-[#3dd0ff] flex items-center justify-center mb-5 shadow-sm shadow-blue-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 20, className: "text-white", strokeWidth: 2.5 }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[16px] text-slate-500 leading-relaxed font-medium", children: "Captures real job details the first time" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[42px] h-[42px] rounded-full bg-[#3dd0ff] flex items-center justify-center mb-5 shadow-sm shadow-blue-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 20, className: "text-white", strokeWidth: 2.5 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[21px] font-bold text-slate-900 mb-2.5 leading-tight", children: "Works Alongside JobNimbus" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[16px] text-slate-500 leading-relaxed font-medium", children: "Improves intake without changing your system" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[42px] h-[42px] rounded-full bg-[#3dd0ff] flex items-center justify-center mb-5 shadow-sm shadow-blue-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 20, className: "text-white", strokeWidth: 2.5 }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[16px] text-slate-500 leading-relaxed font-medium", children: "Your team gets info instantly" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[42px] h-[42px] rounded-full bg-[#3dd0ff] flex items-center justify-center mb-5 shadow-sm shadow-blue-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 20, className: "text-white", strokeWidth: 2.5 }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[16px] text-slate-500 leading-relaxed font-medium", children: "Focus on real jobs, not wasted calls" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[42px] h-[42px] rounded-full bg-[#3dd0ff] flex items-center justify-center mb-5 shadow-sm shadow-blue-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 20, className: "text-white", strokeWidth: 2.5 }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[16px] text-slate-500 leading-relaxed font-medium", children: "Same process on every call" })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-32 bg-white relative overflow-hidden text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 lg:px-12 text-center relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl lg:text-[64px] font-extrabold tracking-tight text-slate-900 mb-8 max-w-4xl mx-auto leading-[1.1]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent", children: "Slow Down Your Workflow" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[18px] text-slate-500 font-medium max-w-2xl mx-auto mb-10 leading-[1.6]", children: "If you use JobNimbus, you don’t need a new system. You need every call handled the right way." }),
...
const $$Jobnimbus = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "JobNimbusHomepage", JobNimbusHomepage, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/levicandiff/Desktop/Cllient Websites Astro/Restoration-AI-website-2026/src/components/integrations/JobNimbusHomepage", "client:component-export": "default" })} ${renderComponent($$result2, "BookACall", BookACall, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/levicandiff/Desktop/Cllient Websites Astro/Restoration-AI-website-2026/src/components/BookACall", "client:component-export": "default" })} ` })}`;
}, "/Users/levicandiff/Desktop/Cllient Websites Astro/Restoration-AI-website-2026/src/pages/integrations/jobnimbus.astro", void 0);
const $$file = "/Users/levicandiff/Desktop/Cllient Websites Astro/Restoration-AI-website-2026/src/pages/integrations/jobnimbus.astro";
const $$url = "/integrations/jobnimbus";
