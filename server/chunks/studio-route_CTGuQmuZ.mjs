...
import { c as createComponent } from "./astro-component_DU7xFC4O.mjs";
import { g as addAttribute, l as renderHead, n as renderComponent, r as renderTemplate } from "./worker-entry_C4ndxhzi.mjs";
...
const a$2 = /^https?:\/\//i, s$1 = function(e2) {
...
function s(r$1, a2) {
  const i2 = [], u2 = n.reduce((e2, t2) => (e2[t2] = e2[t2] || [], e2), { processOptions: [r], validateOptions: [s$1] });
  function l3(e2) {
  ...
  }, l3.clone = () => s(i2, a2), r$1.forEach(l3.use), l3;
}
var a$1, i, u$2 = /* @__PURE__ */ c$2((function() {
  if (i) return a$1;
  i = 1;
  var e2 = function(e3) {
...
const c$1 = "function" == typeof XMLHttpRequest ? "xhr" : "fetch", h$1 = "xhr" === c$1 ? XMLHttpRequest : l$2, d$2 = (e2, t2) => {
  const r2 = e2.options, o2 = e2.applyMiddleware("finalizeOptions", r2), n2 = {}, s2 = e2.applyMiddleware("interceptRequest", void 0, { adapter: c$1, context: e2 });
  if (s2) {
    const e3 = setTimeout(t2, 0, null, s2);
    return { abort: () => clearTimeout(e3) };
  }
  let a2 = new h$1();
  a2 instanceof l$2 && "object" == typeof o2.fetch && a2.setInit(o2.fetch, o2.useAbortSignal ?? true);
  const i2 = o2.headers, d2 = o2.timeout;
  let p2 = false, f = false, b = false;
  if (a2.onerror = (e3) => {
    m(a2 instanceof l$2 ? e3 instanceof Error ? e3 : new Error(`Request error while attempting to reach is ${o2.url}`, { cause: e3 }) : new Error(`Request error while attempting to reach is ${o2.url}${e3.lengthComputable ? `(${e3.loaded} of ${e3.total} bytes transferred)` : ""}`));
  }, a2.ontimeout = (e3) => {
    ...
    d2 && (w2(), n2.socket = setTimeout(() => y2("ESOCKETTIMEDOUT"), d2.socket)), !p2 && a2 && 4 === a2.readyState && 0 !== a2.status && (function() {
      if (!(p2 || f || b)) {
        ...
        w2(), f = true, t2(null, { body: a2.response || ("" === a2.responseType || "text" === a2.responseType ? a2.responseText : ""), url: o2.url, method: o2.method, headers: u$2(a2.getAllResponseHeaders()), statusCode: a2.status, statusMessage: a2.statusText });
      }
    })();
  ...
  return o2.rawBody && (a2.responseType = "arraybuffer"), e2.applyMiddleware("onRequest", { options: o2, adapter: c$1, request: a2, context: e2 }), a2.send(o2.body || null), d2 && (n2.connect = setTimeout(() => y2("ETIMEDOUT"), d2.connect)), { abort: function() {
    p2 = true, a2 && a2.abort();
  } };
  function y2(t3) {
    b = true, a2.abort();
...
var p = { 0: 8203, 1: 8204, 2: 8205, 3: 8290, 4: 8291, 5: 8288, 6: 65279, 7: 8289, 8: 119155, 9: 119156, a: 119157, b: 119158, c: 119159, d: 119160, e: 119161, f: 119162 }, l2 = { 0: 8203, 1: 8204, 2: 8205, 3: 65279 }, d = { 0: String.fromCodePoint(l2[0]), 1: String.fromCodePoint(l2[1]), 2: String.fromCodePoint(l2[2]), 3: String.fromCodePoint(l2[3]) }, u = new Array(4).fill(String.fromCodePoint(l2[0])).join("");
function A(e2) {
  let r2 = JSON.stringify(e2), t2 = new TextEncoder().encode(r2), i2 = "";
  for (let c2 = 0; c2 < t2.length; c2++) {
    let n2 = t2[c2];
    i2 += d[n2 >> 6 & 3] + d[n2 >> 4 & 3] + d[n2 >> 2 & 3] + d[n2 & 3];
  }
  return u + i2;
}
function I(e2) {
...
function y(e2, r2, t2 = "auto") {
  return t2 === true || t2 === "auto" && (I(e2) || S(e2)) ? e2 : `${e2}${A(r2)}`;
}
Object.fromEntries(Object.entries(d).map((e2) => [e2[1], +e2[0]]));
Object.fromEntries(Object.entries(p).map((e2) => e2.reverse()));
var h = `${Object.values(p).map((e2) => `\\u{${e2.toString(16)}}`).join("")}`, x = new RegExp(`[${h}]{4,}`, "gu");
function P(e2) {
  var r2;
  return { cleaned: e2.replace(x, ""), encoded: ((r2 = e2.match(x)) == null ? void 0 : r2[0]) || "" };
}
function w(e2) {
  return e2 && JSON.parse(P(JSON.stringify(e2)).cleaned);
}
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap_CQZ9yySp.mjs").then(function(n2) {
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => import("./browser_DHqOvk_e.mjs").then((n2) => n2.b)).pipe(
  ...
  constructor(httpRequest, config2 = defaultConfig) {
    ...
    this.#httpRequest = requestHandler ? /* @__PURE__ */ (() => {
      ...
      return (options, requester2) => {
        const opts = options;
        return bareClient || (bareClient = new SanityClient(httpRequest, { ...config2, _requestHandler: void 0 })), requestHandler(opts, (o2) => httpRequest(o2, requester2), bareClient);
      };
...
const sanityClient = createClient(
  { "apiVersion": "2024-01-01", "projectId": "sloj5um4", "dataset": "production", "useCdn": true }
);
...
const page = () => _page;
const studioRoute___astro = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  page
}, Symbol.toStringTag, { value: "Module" }));
export {
  isRecord as i,
  studioRoute___astro as s,
  y
};
