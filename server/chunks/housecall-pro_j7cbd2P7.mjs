...
function HousecallProHomepage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen bg-white font-sans overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative z-10 pt-36 pb-32 px-6 lg:px-12 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-6 md:space-y-7", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[17px] text-slate-500 max-w-[540px] leading-[1.6] font-medium", children: "Restoration AI works alongside Housecall Pro so your team can answer every call, capture better job details, and move faster without changing your system." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative z-10 pt-24 pb-12 px-6 max-w-[800px] mx-auto text-center space-y-7", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-[36px] md:text-[46px] lg:text-[52px] font-extrabold text-slate-900 tracking-tight leading-[1.1]", children: "Housecall Pro Is Only as Good as the Information Going Into It" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 flex flex-col items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[17px] text-slate-500 leading-[1.6] font-medium max-w-3xl", children: "Housecall Pro helps manage your jobs, but it still depends on how calls are handled. If calls are rushed, inconsistent, or handled the wrong way, your team starts every job with bad information. Restoration AI fixes that by making sure every call is handled properly before it ever reaches your workflow." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pb-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-[42px] h-[42px] rounded-full bg-[#3dd0ff] flex items-center justify-center mb-5 shadow-sm shadow-blue-500/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 20, className: "text-white", strokeWidth: 2.5 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[21px] font-bold text-slate-900 mb-2.5 leading-tight", children: "Works Alongside Housecall Pro" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-32 bg-white relative overflow-hidden text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 lg:px-12 text-center relative z-10", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[18px] text-slate-500 font-medium max-w-2xl mx-auto mb-10 leading-[1.6]", children: "If you use Housecall Pro, you don’t need a new system. You need every call handled the right way." }),
...
const $$HousecallPro = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "HousecallProHomepage", HousecallProHomepage, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/levicandiff/Desktop/Cllient Websites Astro/Restoration-AI-website-2026/src/components/integrations/HousecallProHomepage", "client:component-export": "default" })} ${renderComponent($$result2, "BookACall", BookACall, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/levicandiff/Desktop/Cllient Websites Astro/Restoration-AI-website-2026/src/components/BookACall", "client:component-export": "default" })} ` })}`;
}, "/Users/levicandiff/Desktop/Cllient Websites Astro/Restoration-AI-website-2026/src/pages/integrations/housecall-pro.astro", void 0);
const $$file = "/Users/levicandiff/Desktop/Cllient Websites Astro/Restoration-AI-website-2026/src/pages/integrations/housecall-pro.astro";
const $$url = "/integrations/housecall-pro";
const _page = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: $$HousecallPro,
  file: $$file,
  url: $$url
