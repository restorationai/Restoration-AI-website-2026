...
export default function EncircleHomepage() {
    return (
        <div className="relative min-h-screen bg-white font-sans overflow-hidden">
            ...
            {/* SECTION 3: PAIN SECTION (Image Left, Text Right) */}
            <section className="relative z-10 py-32 px-6 lg:px-12 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <section className="relative z-10 pb-16 px-6 lg:px-12 max-w-7xl mx-auto">
                <div className="relative">
                    ...
                    <div className="flex flex-col md:flex-row items-stretch justify-between relative mb-24 z-10 gap-8 md:gap-0">
                        ...
                        <div className="w-full md:w-[48%] md:pl-5">
                            <div className="bg-white p-14 lg:p-16 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] h-full flex flex-col justify-center">
                                ...
                                <p className="text-[18px] text-slate-500 leading-relaxed font-medium">While the call is happening, all critical information is captured and structured in real time. Customer details, job context, and scope are organized immediately so your team is not chasing information later or arriving unprepared.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-stretch justify-between relative z-10 gap-8 md:gap-0">
                        ...
                        <div className="w-full md:w-[48%] md:pr-5">
                            <div className="bg-white p-14 lg:p-16 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] h-full flex flex-col justify-center">
                                <h3 className="text-[28px] font-bold text-slate-900 leading-[1.2] mb-5">Your Team Starts Every Job With Complete Information</h3>
                                <p className="text-[18px] text-slate-500 leading-relaxed font-medium">By the time the job is handed off, your team has everything they need to document and execute properly in Encircle. No confusion, no missing details, and no wasted time figuring things out on-site.</p>
                            </div>
                        </div>
                        <div className="w-full md:w-[48%] md:pl-5">
                            <div className="w-full h-full min-h-[300px] rounded-[32px] border border-blue-400/30 bg-blue-50/40 shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col items-center justify-center p-8 relative overflow-hidden">
