...
export default function EncircleHomepage() {
    return (
        <div className="relative min-h-screen bg-white font-sans overflow-hidden">
            ...
            <section className="relative z-10 pt-36 pb-32 px-6 lg:px-12 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div className="flex-1 space-y-7">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 border border-blue-100 mb-2">
                        <span className="text-[13px] font-bold text-blue-600 tracking-wide uppercase">Encircle Integration</span>
                    </div>
                    <h1 className="text-5xl lg:text-[60px] font-extrabold leading-[1.1] tracking-tight text-slate-900">
                        ...
                        <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Now Every Call<br />
                            Logs a Claim in Encircle.</span>
                    </h1>

                    <p className="text-[17px] text-slate-500 max-w-[540px] leading-[1.6] font-medium">
                        Keep your Encircle workflow exactly the way it already runs. Restoration AI makes sure every call is answered, every job is captured, and the right information reaches your team without adding more work to your office.
                    </p>
                    ...
                    <div className="flex flex-wrap items-center gap-5 pt-4">
                        ...
                        <a href="/#calendar-section" className="group px-10 py-4 lg:py-5 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-full font-bold text-[18px] shadow-[0_0_25px_rgba(28,91,255,0.35)] hover:from-blue-700 hover:to-blue-900 transition hover:scale-[1.02] transform flex items-center gap-2 justify-center">
                            Book a Strategy Call <ChevronRight size={20} className="text-white group-hover:translate-x-1 transition-transform" />
                        </a>
                    </div>
                </div>
                ...
                <div className="flex-1 w-full flex justify-center lg:justify-end lg:self-start lg:mt-12">
                    <img
                        src="https://assets.cdn.filesafe.space/Tx5eKisj3Xluq1SeZKe3/media/69e507ee2c135a8c835819e7.png"
                        alt="Encircle Logo"
            ...
            <section className="relative z-10 pt-24 pb-12 px-6 max-w-[800px] mx-auto text-center space-y-7">
                <h2 className="text-[36px] md:text-[46px] lg:text-[52px] font-extrabold text-slate-900 tracking-tight leading-[1.1]">
                    Encircle Is Only as Good as the Information Going Into It
                </h2>
                <div className="space-y-8 flex flex-col items-center">
                    <p className="text-[17px] text-slate-500 leading-[1.6] font-medium max-w-3xl">
                        Encircle is powerful when your team has clear, complete job information in the field. But when intake is rushed or inconsistent, crews start with missing details, unclear scope, and gaps they have to figure out on-site. Restoration AI captures the right information from the start so your team walks into every job prepared instead of piecing things together.
                    </p>
            ...
            <section className="relative z-10 pt-8 pb-24 px-6 max-w-[800px] mx-auto text-center space-y-7">
                ...
                <p className="text-[17px] text-slate-500 leading-[1.6] font-medium">
                    From the first ring to a fully structured job ready for your team, everything is handled in real time without adding extra work to your office. No typing, no callbacks, and no confusion. Just clean, consistent intake that sets your team up to execute jobs faster and more efficiently in the field.
                </p>
            </section>
                ...
                <div className="relative">
                    ...
                    <div className="flex flex-col gap-10 md:gap-14 relative z-10 w-full py-8">
                        ...
                        <div className="bg-white p-10 lg:p-14 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col items-center text-center mx-auto max-w-4xl w-full relative z-10">
                            ...
                            <p className="text-[17px] lg:text-[18px] text-slate-500 leading-relaxed font-medium">While the call is happening, all critical information is captured and structured in real time. Customer details, job context, and scope are organized immediately so your team is not chasing information later or arriving unprepared.</p>
                        </div>
                        
                        {/* STEP 3 */}
                        <div className="bg-white p-10 lg:p-14 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col items-center text-center mx-auto max-w-4xl w-full relative z-10">
                            <h3 className="text-[28px] lg:text-[32px] font-bold text-slate-900 leading-[1.2] mb-4">Your Team Starts Every Job With Complete Information</h3>
                            <p className="text-[17px] lg:text-[18px] text-slate-500 leading-relaxed font-medium">By the time the job is handed off, your team has everything they need to document and execute properly in Encircle. No confusion, no missing details, and no wasted time figuring things out on-site.</p>
                        </div>
                    </div>
{/* CTA Card */}
                    <div className="flex justify-center mt-16 relative z-20">
                        <div className="bg-white p-10 lg:p-12 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] text-center space-y-6 max-w-2xl w-full">
                            ...
                            <div className="flex flex-wrap justify-center items-center gap-5 pt-2">
                                ...
                                <a href="/#calendar-section" className="group px-10 py-4 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-full font-bold text-[18px] shadow-[0_0_25px_rgba(28,91,255,0.35)] hover:from-blue-700 hover:to-blue-900 transition hover:scale-[1.02] transform flex items-center gap-2 justify-center">
                                    Book a Strategy Call <ChevronRight size={20} className="text-white group-hover:translate-x-1 transition-transform" />
                                </a>
                            </div>
                        </div>
            ...
            <section className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 pb-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
                    <div className="bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]">
                        ...
                        <p className="text-[16px] text-slate-500 leading-relaxed font-medium">Every call instantly creates a new job record inside Encircle exactly how your team expects it.</p>
                    </div>
                    <div className="bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]">
                        <div className="w-[42px] h-[42px] rounded-full bg-[#3dd0ff] flex items-center justify-center mb-5 shadow-sm shadow-blue-500/20">
                            <CheckCircle2 size={20} className="text-white" strokeWidth={2.5} />
                    ...
                    <div className="bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]">
                        ...
                        <p className="text-[16px] text-slate-500 leading-relaxed font-medium">Call data and job site context are attached directly to the Encircle file automatically.</p>
                    </div>
                    <div className="bg-white p-8 lg:p-9 rounded-[32px] border border-blue-400/30 shadow-[0_0_25px_rgba(59,130,246,0.15)]">
                        <div className="w-[42px] h-[42px] rounded-full bg-[#3dd0ff] flex items-center justify-center mb-5 shadow-sm shadow-blue-500/20">
                            <CheckCircle2 size={20} className="text-white" strokeWidth={2.5} />
