                    ...
                    <div className="flex flex-col md:flex-row items-stretch justify-between relative mb-24 z-10 gap-8 md:gap-0">
                        ...
                        <div className="w-full md:w-[48%] md:pl-5">
                            <div className="bg-white p-14 lg:p-16 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] h-full flex flex-col justify-center">
                                ...
                                <p className="text-[18px] text-slate-500 leading-relaxed font-medium">While the call is happening, all critical information is captured and structured in real time. Customer details, job context, and scope are organized immediately so your team is not chasing information later or guessing once they arrive on-site.</p>
                            </div>
                        </div>
                    </div>
