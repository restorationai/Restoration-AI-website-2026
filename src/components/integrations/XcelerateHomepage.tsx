            ...
            <section className="relative z-10 pb-16 px-6 lg:px-12 max-w-7xl mx-auto">
                <div className="relative">
                    ...
                    <div className="flex flex-col md:flex-row items-stretch justify-between relative mb-24 z-10 gap-8 md:gap-0">
                        ...
                        <div className="w-full md:w-[48%] md:pr-5">
                            <div className="bg-white p-14 lg:p-16 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] h-full flex flex-col justify-center">
                                ...
                                <p className="text-[18px] text-slate-500 leading-relaxed font-medium">Every incoming call is answered instantly and handled with consistency. Restoration AI understands restoration job types and urgency, ensuring every caller is handled professionally and no important details are missed.</p>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row items-stretch justify-between relative mb-24 z-10 gap-8 md:gap-0">
                        ...
                        <div className="w-full md:w-[48%] md:pl-5">
                            <div className="bg-white p-14 lg:p-16 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] h-full flex flex-col justify-center">
                                ...
                                <p className="text-[18px] text-slate-500 leading-relaxed font-medium">All important job details are captured and structured in real time so your team receives complete and organized information without needing to follow up or fix intake later.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row items-stretch justify-between relative z-10 gap-8 md:gap-0">
                        ...
                        <div className="w-full md:w-[48%] md:pr-5">
                            <div className="bg-white p-14 lg:p-16 rounded-[32px] border border-blue-400/30 shadow-[0_0_30px_rgba(59,130,246,0.15)] h-full flex flex-col justify-center">
                                <h3 className="text-[28px] font-bold text-slate-900 leading-[1.2] mb-5">Structured for Your Xcelerate Workflow From the Start</h3>
                                <p className="text-[18px] text-slate-500 leading-relaxed font-medium">Jobs are prepared in a way that fits your existing Xcelerate workflow so your team can immediately take action without changing how they operate.</p>
                            </div>
                        </div>
                        <div className="w-full md:w-[48%] md:pl-5">
                            <div className="w-full h-full min-h-[300px] rounded-[32px] border border-blue-400/30 bg-blue-50/40 shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col items-center justify-center p-8 relative overflow-hidden">
