      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white border border-blue-700/30 rounded-3xl p-8 shadow-[0_0_40px_rgba(14,165,233,0.08)] relative overflow-hidden group">
            ...
            <div className="mt-12">
               <a href="/#calendar-section" className="flex items-center justify-center gap-2 w-full bg-gradient-to-r from-blue-600 to-blue-800 shadow-md shadow-blue-900/20 text-white py-4 rounded-2xl font-bold hover:from-blue-700 hover:to-blue-900 transition-all group-hover:gap-4">
